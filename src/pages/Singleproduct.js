        ...
        <div className="row">
            ...
            <div className="col-6">
              <div className="main-product-details">
                ...
                <h3 className="title">Best Watches for Men</h3>
                </div>
                <div className="border-bottom py-3">
                  ...
                  <div className=" py-3">
                    ...
                    <div className="d-flex gap-10 flex-column my-3">
                      <h3 className="product-heading">Shipping & Returns:</h3><p className="product-data">Free shipping and returns available on all orders!<br/>
  ...
  <Container class1="description-wrapper py-5 home-wrapper-2">
        <div className="row">
            ...
            <h4>Description</h4>
                ...
                <p>
                  The product is amazing and the quality is good
                </p>
                </div>
            </div>
        </div>
              ...
              <div className="review-head d-flex justify-content-between align-items-end">
                ...
                <div className="reviews mt-4">
                 ...
                 <div className="d-flex gap-10 align-items-center">
                  <h6 className="mb-0">George</h6>
                 <ReactStars count={5} size={24} value={4} edit={false} activeColor="#ffd700"/>
                 </div>
                  <p className="mt-3">The product is excellent and superb</p>
                  </div>
                </div>
              </div>
            </div>
