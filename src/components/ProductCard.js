...
const ProductCard = (props) => {
 ...
 <>
    ...
    <Link to=
    {`${
      location.pathname=="/"?"/product/:id":location.pathname=="/product/:id"?"/product/:id":":id"}`} className="product-card position-relative">
        ...
        <div className="product-image ">
            ...
            <img src="/images/watch.avif"  className="img-fluid" alt="product image"/>
        </div>
